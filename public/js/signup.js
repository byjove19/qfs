document.addEventListener("DOMContentLoaded", function () {
    ...
    if (form) {
        form.addEventListener("submit", async (e) => {
            ...
            try {
                // Get phone input with country code
                ...
                // Prepare form data - match backend expectations
                const formData = {
                    firstName: document.getElementById("first_name").value.trim(),
                    lastName: document.getElementById("last_name").value.trim(),
                    email: document.getElementById("email").value.trim(),
                    phone: fullPhoneNumber || document.getElementById("phone").value.trim(),
                ...
                // FIXED: Send to correct endpoint - /auth/register instead of /api/auth/register
